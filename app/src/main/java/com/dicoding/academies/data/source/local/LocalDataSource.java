...
public class LocalDataSource {
    ...
    public LiveData<List<CourseEntity>> getBookmarkedCourses() {
        return mAcademyDao.getSavedNews();
    }
    ...
    public void insertCourse(CourseEntity course) {
        mAcademyDao.insertCourse(course);
    }

    public void insertCourses(ArrayList<CourseEntity> course) {
        mAcademyDao.insertCourses(course);
    }

    public void deleteCourse(CourseEntity course) {
        mAcademyDao.deleteCourse(course);
    }

    public Boolean isNewsSaved(String title) {
        return mAcademyDao.isNewsSaved(title);
    }
